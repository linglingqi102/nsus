...
export default function () {
  return (
    <ComBox title="缴费信息">
      ...
      <div className={styles.content}>银行账号：37150199766500000030</div>
      <h4>（2）现场缴费：</h4>
      <div className={styles.content}>接受pos机刷卡，可扫支付宝或微信，不接受现金及其他方式。需留下发票信息和详细邮寄地址，方便会后邮寄发票。</div>
      <h4>注意：</h4>
      <div>（1）转帐时请务必在附件留言栏内标注“<a href="/">nsus2021+姓名+单位</a>”，并将转账凭证照片或扫描件发送至会议邮箱<a href="/">nsus2020@sdu.edu.cn</a>（邮件主题请写：nsus2021+单位+名字），以方便确认转账。6月30日之前缴费的代表可在报道当日领取会务发票。</div>
      <div>（2）若一人为多个参会人员交纳注册费，要来信说明是为哪些人员交纳了注册费，是谁交纳的，开具发票时是在一起开还是分开。</div>
    </ComBox>
  );
}
